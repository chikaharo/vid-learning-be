...
inputs = {
  ...
  ingress_with_source_security_group_id = [
    # {
    #   rule                     = "mysql-tcp"
    #   description              = "allow access DB from API"
    #   source_security_group_id = dependency.sg_api.outputs.security_group_id
    # },
    {
      rule                     = "all-tcp"
      description              = "allow access ${local.common.name} from ALB"
      source_security_group_id = dependency.sg_ecs_alb.outputs.security_group_id
    }
  ]
}
