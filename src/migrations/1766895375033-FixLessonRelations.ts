...
export class FixLessonRelations1766895375033 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "lessons" DROP CONSTRAINT IF EXISTS "FK_16e7969589c0b789d9868782259"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "lessons" DROP COLUMN IF EXISTS "moduleId"`,
    );

    // 3. Fix column types for course_id and module_id (ensure they are UUID)
    // assuming course_id has data and is correct
    await queryRunner.query(
      `ALTER TABLE "lessons" ALTER COLUMN "course_id" TYPE uuid USING "course_id"::uuid`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "lessons" ALTER COLUMN "module_id" TYPE uuid USING "module_id"::uuid`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "lessons" ADD CONSTRAINT "FK_35fb2307535d90a6ed290af1f4a" FOREIGN KEY ("module_id") REFERENCES "course_modules"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "lessons" ADD CONSTRAINT "FK_16e7969589c0b789d9868782259" FOREIGN KEY ("moduleId") REFERENCES "course_modules"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
